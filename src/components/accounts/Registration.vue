                ...
                <div class="container"> 
                    <div class="form"> 
                        ...
                        <form @submit.prevent="handleLoginSubmit">
                            <div class="inputBx">
                                <input type="text" v-model="first_name" required="required">
                                <span>First Name</span>
                            </div>
                            <div class="inputBx">
                                <input type="text" v-model="last_name" required="required">
                                <span>Last Name</span>
                            </div>
                            <div class="inputBx">
                                <input type="text" v-model="mobile" required="required">
                                <span>Mobile</span>
                            </div>
                            <div class="inputBx">
                            ...
                            <div class="inputBx password">
                                <input id="password-input" v-model="password" type="password" name="password" required="required">
                                <span>Password</span>
                                <a href="#" class="password-control" onclick="show_hide_password;"></a>
                            </div>
                            <div class="inputBx password">
                                <input id="c-password-input" v-model="confirm_password" type="password" name="password" required="required">
...
/* Registration form template End */
</style>